        ...
        var slot = {
            ...
            subSlot: {
                ...
                children: (React__namespace.createElement("div", { "data-testid": "core__inner-current-page-".concat(state.currentPage), style: Object.assign({
                    ...
                    }, virtualizer.getContainerStyles()) }, chunks.map(function (items) { return (React__namespace.createElement("div", { className: "myClass", style: {
...
var PdfWriter = function (_a) {
    ...
    var handleMouseDown = function (event) {
        ...
        var y = event.clientY + window.scrollY + rectDims.top;
